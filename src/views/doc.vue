  ...
  <div class="workview-top">
          ...
          <el-breadcrumb separator="/" style="float:right;margin-bottom:5px;">
              <el-breadcrumb-item>
                ...
                trigger="click">
                <span>
                 <el-input v-model="keyword" placeholder="请输入评论" size="medium" style="width: 300px"></el-input>
                </span>
                <span>
          ...
          <el-table
            ...
            <el-popover
             ...
             width="280"
             trigger="click">
          <accessform :propRightObj="this.rights" :propDocumentID="this.$route.params.id"></accessform>
            <el-button type="text" slot="reference" size="medium">编辑权限</el-button>
           </el-popover>
...
export default {
  ...
  methods: {
    ...
    load_right(id){
      ...
      var _this = this;
      axios
        .post("http://localhost:8080/api/api/tell_doc_right", formData, config)
    ...
    searchuser(){
      ...
      let config = {
            ...
            axios.post(
                "http://localhost:8080/api/api/query_notindoc_user",
              ...
              .catch(function () {
                _this.errormsg("查找失败，请尝试刷新后再次创建2");
              });
          },
    invite(e){
      var _this = this;
    ...
    save_docs() {
      ...
      axios
        .post("http://localhost:8080/api/api/modify_doc", formData, config)
        .then(function (response) {
    ...
    newComment() {
      ...
      axios
        .post("http://localhost:8080/api/api/create_comment", formData, config)
        .then(function (response) {
          if (response.data.message == "success") {
            console.log("成功");
          } else {
    ...
    load_data(id) {
      ...
      var _this = this;
      axios
        .post("http://localhost:8080/api/api/get_doccontent", formData, config)
        .then(function (response) {
          if (response.data.message == "success") {
    ...
    load_comment(id){
      ...
      var _this = this;
      axios
        .post("http://localhost:8080/api/api/get_all_comment", formData, config)
        .then(function (response) {
          if (response) {
    ...
    load_modify_history(id){
      ...
      var _this = this;
      axios
        .post("http://localhost:8080/api/api/get_all_modified_time", formData, config)
        .then(function (response) {
          if (response) {
    ...
    load_id(){
      ...
      axios.post("http://localhost:8080/api/api/get_user", formData1, config1)
        .then(function (response) {
          console.log(response.data)
          if (response) {
            //_this.successmsg("邀请成功");
    ...
    load_title(id){
      ...
      axios
        .post("http://localhost:8080/api/api/get_doctitle", formData1, config)
        .then(function (response) {
          if (response) {
  ...
  mounted: function () {
    ...
    this.load_id();
        console.log("lalalalalalala"+localStorage.getItem('token'));
    console.log("lalalalalalala"+this.$route.params.id);
  },
  computed:{
    DOCtitle(){
