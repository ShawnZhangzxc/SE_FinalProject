<template>
  ...
  <el-popover
    ...
    width="500"
    trigger="click">
    <el-button icon="el-icon-document-add" slot="reference">创建一个新的团队文档</el-button>
...
name: 'createTeamDoc',
  ...
  methods: {
    ...
    //   formData.append("content", _this.newdocform.content);
            ...
            formData.append("groupid", this.teamid);
      ...
      axios.post("http://localhost:8080/api/api/create_group_doc", formData, config)
